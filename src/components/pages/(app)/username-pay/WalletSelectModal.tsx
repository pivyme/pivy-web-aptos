      ...
      <div className="flex items-center gap-4 p-4 w-full">
        <div className="w-12 h-12 rounded-full bg-gray-100 flex items-center justify-center overflow-hidden">
          <img
            src={
              imageError
                ? "/assets/chains/aptos.svg"
                : wallet.icon || "/assets/chains/aptos.svg"
            }
            alt={wallet.name}
...
export default function WalletSelectModal({
  ...
  return (
    <CuteModal isOpen={isOpen} onClose={onClose} title="Connect Wallet" size="lg">
      <div className="flex flex-col min-h-[400px]">
        <div className="text-center mb-4">
          <h2 className="text-lg font-bold">Connect your Aptos Wallet</h2>
          <p className="text-gray-600 text-sm">Choose a wallet to connect</p>
        </div>
